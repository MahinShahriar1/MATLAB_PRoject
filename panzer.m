classdef panzer
    ...
    methods
        function obj = panzer(varargin)
            ...
            obj.life = 100;
            obj.sprite.X = game.X{obj.kind};
            obj.sprite.Y = game.Y{obj.kind};
            obj.sprite.sprite = game.sprites{obj.kind}; % game is variable which is set in sprite_generator. file.
        end
